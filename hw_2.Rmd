...
The coattails effect is what the scenarios highlight more than anything. The unemployment rate is fairly inconsequential for the level of the forecasts, however, predicting that the Democrats lose the presidential election in 2020 would essentially wipe out the forecasted increase in Democratic House seats for h=2 and h=3. The variation around the predictions is somewhat large though---e.g. f
